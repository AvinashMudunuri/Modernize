            ...
            <div id="header">
              ...
              <div style="width:570px;height:100px;float:left">
	           	  <div style="width:100%;height:58px;float:left">
                   		<div id="welcomeuser">
                        	<span class="headinglog" style="line-height:20px">Welcome, <?php echo $_SESSION['MM_fname'];?> 
								<?php echo $_SESSION['MM_lname']; ?>
                   ...
                   <div style="width:100%;height:42px;float:left;background:url(images/logo_navbg.jpg) repeat-x">
                    	<ul id="nav">
                            ...
                            <li class="top">
                                ...
                                href="http://www.softsol.net/contactus.aspx?KeepThis=true&TB_iframe=true&height=450&width=640" title="Contact Us">
